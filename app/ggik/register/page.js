        ...
        <main className="flex fixed h-full w-full bg-page-ggik overflow-auto flex-col items-center justify-center pt-2 pb-2 px-5 lg:pt-0 lg:px-20 mt-0">
                ...
                <div className='relative w-[90%] mb-6'>
                    ...
                    <div className='relative w-full'>
                        <Image
                            ...
                            alt='icon'
                        />
                        <p className={`absolute left-[2.1rem] top-1/2 font-bold text-base text-[#760000]  -translate-y-1/2 ${poppins.className}`}>+62</p>
                        <input
                            type='number'
                            value={payload.phone}
                            id='phone'
                            name='phone'
                            className={`w-full rounded-lg font-semibold text-base outline-none py-3 pr-3 pl-[4.5rem] text-[#760000]  bg-light ${poppins.className}`}
            ...
            <div className="relative w-[90%] mx-auto flex justify-center items-center flex-col">
                <button className={`w-full relative mx-auto flex justify-center items-center ${payload.phone ? '' : 'pointer-events-none opacity-10'}`} onClick={handleSubmit}>
                    <Image src='/btn-next-ggik.png' width={867} height={163} alt='Zirolu' className='w-full' priority />
                </button>
                <Link href='/ggik' className="relative w-full mx-auto flex justify-center items-center pt-6">
