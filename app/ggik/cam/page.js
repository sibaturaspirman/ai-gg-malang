    ...
    return (
        <main className="flex fixed h-full w-full bg-page-ggik overflow-auto flex-col justify-center items-center py-5 px-5 lg:py-16 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <div className="relative w-full flex flex-col justify-center items-center mt-8">
                ...
                {!enabled && 
                    <p className='block text-center text-base lg:text-4xl mt-1 mb-3 lg:mt-4 text-[#760000]'>*Ikuti garis pose dan tidak terlalu zoom</p> 
                }
            </div>
            ...
            {!enabled && 
                <div className="relative left-0 mt-4 w-full flex justify-center items-center flex-col">
                    <button className="relative mx-auto flex w-[70%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/btn-capture-ggik.png' width={867} height={146} alt='Zirolu' className='w-full' priority />
                    </button>
                    <Link href='/ggik' className="relative w-[70%] mx-auto flex justify-center items-center pt-4">
            ...
            <div className={`relative left-0 w-full mt-4 ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[70%] mx-auto flex justify-center items-center flex-col">
                    <Link href='/ggik/generate' className="w-full relative mx-auto flex justify-center items-center">
                        <Image src='/btn-next-ggik.png' width={867} height={146} alt='Zirolu' className='w-full' priority />
                    </Link>
                    <button className="relative w-full mx-auto flex justify-center items-center pt-2" onClick={retake}>
                        <Image src='/btn-retake-ggik-2.png' width={867} height={146} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            </div>
        </main>
